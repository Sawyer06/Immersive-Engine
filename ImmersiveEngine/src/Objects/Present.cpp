...
void Present::Space::updateTransforms(Shader shaderProgram)
{
    ...
    m_matrix = glm::rotate(m_matrix, orientation.x, glm::vec3(1.0f, 0.0f, 0.0f));
    m_matrix = glm::rotate(m_matrix, orientation.y, glm::vec3(0.0f, 1.0f, 0.0f));
    m_matrix = glm::rotate(m_matrix, orientation.z, glm::vec3(0.0f, 0.0f, 1.0f));
